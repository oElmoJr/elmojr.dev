...
import goodreads from "../../assets/social_Icons/goodreads.svg";
import spotify from "../../assets/social_Icons/spotify.svg";
import pinterest from "../../assets/social_Icons/pinterest.svg";
import elmobot from "../../assets/social_Icons/elmobot.svg";
import bluesky from "../../assets/social_Icons/bluesky.svg";
import threads from "../../assets/social_Icons/threads.svg";

export { linkedin, github, email, telegram, instagram, twitter, goodreads, spotify, pinterest, elmobot, bluesky, threads };
